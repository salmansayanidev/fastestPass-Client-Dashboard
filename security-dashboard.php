                                ...
                                <div class="security-dashboard-left">
                                    ...
                                    <div class="security-score-area">
                                        <div class="sec-score-top">
                                            ...
                                            <p class="para m-0">Add items to your vault so you can monitor your email addresses. <a class="text-decoration-none" href="#">Learn more</a></p>
                                        </div>
                                        <div class="dark-web-monitoring-bottom">
                                            <button class="add-items-vault-btn" type="button">
                                                <span class="plus-icon">
                                                    <i class="fa-solid fa-plus"></i>
                                                </span>
                                                <span class="">
                                                    Add items to <br> your vault
                                                </span>
                                            </button>
                                        </div>
                                    </div>
